...
export function GenerativeArtScene({ color = "#00bcd4" }: GenerativeArtSceneProps) {
...
export function AnomalousMatterHero({
  title = "MediQueue Platform",
  subtitle = "Smart Queues. Zero Wait Anxiety.",
  description = "Real-time queue management with QR tokens, digital waiting rooms, and AI-powered scheduling for modern hospitals.",
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#0D1B2E] via-[#0D1B2E]/70 to-transparent z-10" />
      ...
      <div className="relative z-20 flex flex-col items-center justify-end h-full pb-20 md:pb-32 text-center">
        <div className="max-w-3xl px-4 animate-fade-in-long">
          <h1 className="text-sm font-mono tracking-widest text-primary/80 uppercase mb-4">
            {title}
          </h1>
          <p className="text-3xl md:text-5xl font-bold leading-tight text-white">
            {subtitle}
          </p>
          <p className="mt-6 max-w-xl mx-auto text-base leading-relaxed text-white/60">
            {description}
          </p>
        </div>
      </div>
