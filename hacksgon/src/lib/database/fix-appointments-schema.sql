-- Fix appointments table to support enhanced features
...
DROP TRIGGER IF EXISTS trigger_update_appointment_details;
CREATE TRIGGER trigger_update_appointment_details
...
DROP TRIGGER IF EXISTS trigger_notify_waitlist;
...
DROP TRIGGER IF EXISTS trigger_cleanup_waitlist;
